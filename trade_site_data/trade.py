...
def getItemHashes(search_name=None, search_basetype=None, implicits=None, itemlvl=None, quality=None, corrupted=False):
    ...
    # print(payload)
    response = requests.request("POST", url, headers=header_dict, data=payload, verify=False)
...
def getItemResults(hashes):
    ...
    response = requests.request(
        "GET", url, headers=header_dict, data=payload, verify=False)
    resp_obj = response.json()
...
if __name__ == "__main__":
    ...
    print(priceAndNameFromResults(PriceItem(search_basetype="Divine Orb")))